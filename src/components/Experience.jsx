...
de diversos clientes.
                    ...
                    <section className="w-full lg:w-1/2 h-[325px] md:h-[500px] bg-cover" style={{backgroundImage:("url('/Dharma.jpeg')")}}></section>
                </div>

                <div className=" flex flex-col lg:flex-row gap-5"> 
                    <section className="w-full lg:w-1/2 h-[325px] md:h-[500px] bg-cover" style={{backgroundImage:("url('/pasantia.jpg')")}}></section>
                        <section className="w-full lg:w-1/2 gap-5 flex justify-center  flex-col px-0 lg:px-5"> 
