    ...
    return(
        <div className=" flex flex-col w-full justify-center  bg-cover " style={{ textShadow: "0 1px 2px rgba(0, 0, 0, 0.2)" }} >
            <div className="w-full flex flex-col xl:flex-row container mx-auto h-lvh items-center ">
                ...
                <section className="w-full h-[550px] md:[650px] xl:h-auto xl:w-1/4 text-black flex flex-col px-5 md:px-8 lg:px-20 xl:px-0 gap-1 lg:gap-2 justify-end xl:justify-center items-center text-center xl:text-justify z-20">
                ...
                <section className="w-full lg:w-3/6 z-11 h-[650px] md:h-[550px] lg:h-[950px] xl:h-full  relative"><Image src={"/foto-con-gorra.png"}  
                alt="Fondo-yo"
                fill
                className="object-cover md:object-contain lg:object-cover object-bottom " 
                priority/></section>

                <section className="w-full  h-[500px] xl:h-full  xl:w-1/4 text-black z-20  hidden md:flex flex-col px-5 md:px-8 lg:px-20 xl:px-0 container mx-auto gap-1 lg:gap-2 justify-center items-center text-center xl:text-justify">
